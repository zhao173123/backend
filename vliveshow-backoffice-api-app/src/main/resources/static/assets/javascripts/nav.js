...
$(document).ready(function() {
    ...
    $("body").on(click_event,"#main-nav .dropdown-collapse", function(e) {
        ...
        if (list.is(":visible")) {
            if (body.hasClass("main-nav-closed") && link.parents("li").length === 1 && nWidth > 768) {
                return false;
            } else {
                link.removeClass("in");
            ...
            if (list.parents("ul.nav.nav-stacked").length === 1 && nWidth > 768) {
    ...
    $("body").on(click_event,"#main-nav ul.nav.nav-stacked > li", function(e) {
        ...
        $("#main-nav ul.nav.nav-stacked").removeClass("in");
        $(this).parent("ul.nav.nav-stacked").addClass("in");
...
this.nav_open = function() {
    return $("body").hasClass("main-nav-opened");
